...
public static class PrimordialDuckConstants
{
    ...
    public static class ErrorMessages
    {
        ...
        public const string DormantDuckRequiresHeartRate = "Batimentos cardíacos são obrigatórios para patos em transe ou hibernação profunda";
    }
    ...
    public static class HibernationStatusDescriptions
    {
        ...
        public const string InTrance = "Hibernação Leve";
        public const string DeepHibernation = "Hibernação Profunda";
    }
}
